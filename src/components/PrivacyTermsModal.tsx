...
export const PrivacyTermsModal: React.FC<PrivacyTermsModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 overflow-y-auto">
      <div className="relative w-full max-w-2xl my-8 rounded-3xl bg-white p-6 sm:p-8 shadow-2xl border border-gray-100 max-h-[85vh] flex flex-col animate-in fade-in duration-150">
        {/* Header */}
        <div className="flex items-center justify-between pb-4 border-b border-gray-100 shrink-0">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-bold text-gray-900">Healthcare Privacy &amp; Terms</h2>
              <p className="text-xs text-gray-500">Functional Rehab Lab, Thiruvananthapuram</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="mt-4 space-y-4 text-xs sm:text-sm text-gray-600 overflow-y-auto pr-1 leading-relaxed">
          ...
          <section className="space-y-1.5">
            <h3 className="font-bold text-gray-900 text-sm">3. Local Device Storage &amp; Demo Mode</h3>
            <p>
          ...
          <section className="space-y-1.5">
            <h3 className="font-bold text-gray-900 text-sm">4. Medical Information Disclaimer</h3>
            <p>
          ...
          <section className="space-y-1.5">
            <h3 className="font-bold text-gray-900 text-sm">5. Contact Clinic Regarding Records</h3>
            <p>
