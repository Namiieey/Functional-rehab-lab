...
export const MobileBottomBar: React.FC<MobileBottomBarProps> = ({ onNavigate, onOpenAuth }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-30 sm:hidden bg-[#121216]/95 backdrop-blur-md border-t border-white/10 py-2 px-3 shadow-2xl shadow-black">
      <div className="grid grid-cols-4 gap-1 items-center">
        {/* Call Now */}
        <a
          href={CLINIC_INFO.telUrl}
          id="mobile-bottom-call"
          className="flex flex-col items-center justify-center py-1 rounded-xl text-gray-300 hover:text-white active:bg-white/10 transition"
        >
        ...
        <button
          ...
          className="flex flex-col items-center justify-center py-1 rounded-xl bg-brand-primary text-white shadow-lg shadow-brand-primary/25 active:scale-95 transition"
        >
