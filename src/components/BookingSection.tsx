...
export const BookingSection: React.FC<BookingSectionProps> = ({
  ...
  return (
    <section id="book" className="py-16 sm:py-20 bg-white border-t border-gray-100 scroll-mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="p-5 rounded-2xl bg-[#fafbfc] border border-gray-200/80 space-y-3.5">
            ...
            {lastRequestedRef && (
              <div className="p-4 rounded-2xl bg-emerald-50 border border-emerald-200 text-xs text-emerald-900 space-y-2 animate-in fade-in duration-150">
                <div className="flex items-center gap-2 font-bold text-emerald-800">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600" />
                  <span>WhatsApp Message Prepared</span>
                </div>
                <p>
                  Reference: <strong className="font-mono">{lastRequestedRef}</strong>.
          ...
          <div className="lg:col-span-7">
            <div className="rounded-3xl bg-[#fafbfc] p-6 sm:p-8 lg:p-10 border border-gray-200/80 shadow-xs">
              <form onSubmit={handleBookViaWhatsApp} className="space-y-5">
                ...
                <div>
                  <label className="block text-xs font-semibold text-gray-700 mb-1.5">
                    Service / Treatment <span className="text-red-500">*</span>
                  </label>
                  <select
                    value={serviceId}
                ...
                <button
                  ...
                  className="w-full py-4 px-6 rounded-2xl bg-[#25D366] text-white font-bold text-sm hover:bg-[#1EBE5D] transition active:scale-[0.99] flex items-center justify-center gap-2 shadow-sm"
                >
